...
public class GoogleMail {
    ...
    public static void Send(String recipientEmail, String title, String message) throws AddressException, MessagingException, UnsupportedEncodingException {
    	String username= ConfigUtil.GMAIL_USERNAME;
    	String password= ConfigUtil.GMAIL_PASSWORD;
        if(logger.isDebugEnabled()){
    	logger.debug("Parameters for mail : recipientEmail :"+recipientEmail+" title :"+title+" message :"+message);
        }
