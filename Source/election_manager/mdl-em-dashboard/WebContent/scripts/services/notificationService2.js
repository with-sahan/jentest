...
angular.module('newApp').service(serviceName, 
        ...
        vm.getAllNotifications = function(callback){
    		...
    		var authEndpoint = vm.mdlApiBaseUrl + 'notification/global';
        ...
        vm.getlNotificationsByHierarchy = function(hierarchyid,callback){
    		...
    		var body = {"token":"","hierarchyId":hierarchyid};
    		
    		
    		var authEndpoint = vm.mdlApiBaseUrl+'notification/notificationsbyhierarchy';
        ...
        vm.getNotificationByID = function(callback, notificationid){
    		...
    		var authEndpoint = vm.mdlApiBaseUrl+'notification/id';
