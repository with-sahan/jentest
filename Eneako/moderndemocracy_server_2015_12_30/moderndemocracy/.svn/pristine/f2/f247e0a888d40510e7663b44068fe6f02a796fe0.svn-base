...
public class StationSetupList implements ToJSON {

	protected static final Logger logger = LogManager.getLogger(StationSetupList.class);
	...
	public String toString() {
		return "StationSetupList [id=" + id + ", text=" + text + ", orderId="
	...
	public JsonMarshaler createMarshaller() {
		return new StationSetupListMarshaler();
	}
