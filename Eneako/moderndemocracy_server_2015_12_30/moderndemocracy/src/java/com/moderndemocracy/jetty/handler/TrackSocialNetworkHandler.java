...
public class TrackSocialNetworkHandler extends ModernDemocracyHandler {
	...
	protected void handlePost(String target, HttpServletRequest request,
		...
		try {
			...
			logger.debug("councilId="+councilId+", socialNetwork="+socialNetwork+", feed="+feed+", feedId="+feedId);
			
			// Insert Tracking 
			trackSocialNetworkDao.insert(userId, councilId, socialNetwork,feed,feedId);
