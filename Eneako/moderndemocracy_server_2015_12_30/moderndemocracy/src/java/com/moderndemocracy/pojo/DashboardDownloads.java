...
import com.moderndemocracy.json.DashboardDownloadsMarshaler;

public class DashboardDownloads implements ToJSON {

	protected static final Logger logger = LogManager.getLogger(DashboardDownloads.class);
	...
	public JsonMarshaler createMarshaller() {
		return new DashboardDownloadsMarshaler();
	}
