...
import com.moderndemocracy.json.NewsMarshaler;

public class News implements ToJSON {

	protected static final Logger logger = LogManager.getLogger(News.class);
