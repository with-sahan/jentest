...
-- Reset Database data --
-------------------------
delete from notifications where user_id>30000 and user_id<40000;

delete from notifications_received where user_id>30000 and user_id<40000;

update station_setup_status set status=false where station_id>30000 and station_id<40000;
...
delete from issues where council_id>30000 and council_id<40000;

update tracking set lat=0,lng=0, status=0 where station_id>30000 and station_id<40000;
...
council_id>30000 and council_id<40000;
