...
-- Reset Database data --
-------------------------
delete from notifications where user_id>100 and user_id<10000;

delete from notifications_received where user_id>100 and user_id<10000;

update station_setup_status set status=false where station_id>100 and station_id<10000;
...
set ballot_papers_issued=NULL,
	...
	dispatch_time=null,
	deliver_time=null
where id>100 and id<10000;

delete from issues where council_id>100 and council_id<10000;

update tracking set lat=0,lng=0, status=0 where station_id>100 and station_id<10000;
...
council_id>100 and council_id<10000;
