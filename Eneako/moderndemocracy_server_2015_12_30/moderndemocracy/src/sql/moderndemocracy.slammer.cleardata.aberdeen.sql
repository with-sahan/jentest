...
-- Reset Database data --
-------------------------
delete from notifications where station_id>10000 and station_id<20000;

delete from notifications_received where user_id>10000 and user_id<20000;

update station_setup_status set status=false where station_id>10000 and station_id<20000;
...
delete from issues where council_id>10000 and council_id<20000;

update tracking set lat=0,lng=0, status=0 where station_id>10000 and station_id<20000;
...
council_id>10000 and council_id<20000;
