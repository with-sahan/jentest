...
-- Dump completed on 2016-04-26 20:16:23
-- MySQL dump 10.13  Distrib 5.7.9, for Win64 (x86_64)
--
...
BEGIN
    ...
    if (security.fn_validate_token(token)=1) then
		...
		pc.name as name, 
        pc.address as address, 
		pc.phone as phone, 
		pc.email as email, 
        pc.mobile as mobile, 
		pc.primary_contact as primary_contact, 
        pc.pollingstation_election_id as pollingstation_election_id,
        ps.name as pollingstation_name,
        'success' as response
        FROM psm.polling_contacts pc
		inner join psm.polling_station_election pse on pc.pollingstation_election_id=pse.id
		inner join psm.polling_station ps on ps.id=pse.polling_station_id
		where pse.organization_id=orgid and pse.organization_id=orgid
		order by pc.id asc;
    else
		select null as id, 
		null as description,
        ...
        null as pollingstation_election_id, 
...
-- Dump completed on 2016-04-26 20:17:11
-- MySQL dump 10.13  Distrib 5.7.9, for Win64 (x86_64)
--
...
-- Dump completed on 2016-04-26 20:17:18
