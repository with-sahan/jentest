...
--
-- Host: ec2-52-50-215-176.eu-west-1.compute.amazonaws.com    Database: security
-- ------------------------------------------------------
...
-- Dump completed on 2016-04-19 10:23:11
-- MySQL dump 10.13  Distrib 5.7.9, for Win64 (x86_64)
--
-- Host: ec2-52-50-215-176.eu-west-1.compute.amazonaws.com    Database: subscription
-- ------------------------------------------------------
-- Server version	5.5.46-0ubuntu0.14.04.2
use `subscription`;
/*!40101 SET @OLD_CHARACTER_SET_CLIENT=@@CHARACTER_SET_CLIENT */;
...
-- Dump completed on 2016-04-19 10:23:24
-- MySQL dump 10.13  Distrib 5.7.9, for Win64 (x86_64)
--
-- Host: ec2-52-50-215-176.eu-west-1.compute.amazonaws.com    Database: psm
-- ------------------------------------------------------
-- Server version	5.5.46-0ubuntu0.14.04.2
use `psm`;
/*!40101 SET @OLD_CHARACTER_SET_CLIENT=@@CHARACTER_SET_CLIENT */;
...
BEGIN
    ...
    DECLARE response varchar(255);
	select TIME(deliver_time) into response from psm.tracking where id=trackid;
RETURN response;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
-- Dump completed on 2016-04-19 10:24:13
