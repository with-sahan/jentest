...
--
-- Host: ec2-52-16-78-172.eu-west-1.compute.amazonaws.com    Database: psm
-- ------------------------------------------------------
...
--
-- Table structure for table `ballot_paper_type`
--

DROP TABLE IF EXISTS `ballot_paper_type`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ballot_paper_type` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `election_id` int(11) NOT NULL,
  `organization_id` int(11) NOT NULL,
  `value_1` varchar(255) DEFAULT 'paper1' COMMENT '1 - default\n',
  `value_2` varchar(255) DEFAULT 'paper2',
  PRIMARY KEY (`id`),
  KEY `orgidfk_idx` (`election_id`),
  KEY `orgidfk_idx1` (`organization_id`),
  CONSTRAINT `elecfk` FOREIGN KEY (`election_id`) REFERENCES `election` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `orgidfk` FOREIGN KEY (`organization_id`) REFERENCES `subscription`.`organization` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `chat` (
  ...
  PRIMARY KEY (`chatid`)
) ENGINE=InnoDB AUTO_INCREMENT=627 DEFAULT CHARSET=utf8 COMMENT='Using for viewing chat messages in issues';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=157 DEFAULT CHARSET=utf8 COMMENT='Counting centers master table';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=618835 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `polling_contacts` (
  ...
  `pollingstation_election_id` int(11) NOT NULL,
  `primary_contact` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `rt_idx` (`pollingstation_election_id`),
  CONSTRAINT `pols_elec_con_fk_1` FOREIGN KEY (`pollingstation_election_id`) REFERENCES `polling_station_election` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=7312 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `psi_check_list`
--

DROP TABLE IF EXISTS `psi_check_list`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `psi_check_list` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `organization_id` int(11) NOT NULL,
  `list_id` int(11) NOT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=67476 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `activeelection`(in electionid int,in orgid int)
BEGIN
...
update psm.notification set createdon=DATE_ADD(current_date,INTERVAL MINUTE(createdon)+60*HOUR(createdon) MINUTE)  
where organization_id=orgid;

update psm.issue set createdon=DATE_ADD(current_date,INTERVAL MINUTE(createdon)+60*HOUR(createdon) MINUTE)  
where organization_id=orgid;

update psm.election_stats set updatedon=DATE_ADD(current_date,INTERVAL MINUTE(updatedon)+60*HOUR(updatedon) MINUTE)  
where organization_id=orgid and electionid=electionid;

update psm.election_close_stats set updatedon=DATE_ADD(current_date,INTERVAL MINUTE(updatedon)+60*HOUR(updatedon) MINUTE)  
where organization_id=orgid and election_id=electionid;

update psm.station_photo set createdon=DATE_ADD(current_date,INTERVAL MINUTE(createdon)+60*HOUR(createdon) MINUTE)  
where organization_id=orgid and election_id=electionid;

update psm.tracking set dispatch_time=DATE_ADD(current_date,INTERVAL MINUTE(dispatch_time)+60*HOUR(dispatch_time) MINUTE)  
where organization_id=orgid and election_id=electionid;

update psm.chat set createdon=DATE_ADD(current_date,INTERVAL MINUTE(createdon)+60*HOUR(createdon) MINUTE)  
where organizationid=orgid;

update psm.csv_upload set updatedon=DATE_ADD(current_date,INTERVAL MINUTE(updatedon)+60*HOUR(updatedon) MINUTE)  
where organization_id=orgid;
...
BEGIN
SELECT pc.name as key_contact_name ,pc.phone as contact_details,  hv.value as place,ps.name as polling_station,pse.isopen as is_open,pse.isclose as is_close FROM psm.polling_station_election as pse 
...
inner join psm.polling_contacts pc on pc.pollingstation_election_id = pse.id 
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `insertPSI`(in username varchar(255), in orgid int,in pollingstationname varchar(255))
BEGIN
declare userid int(11);
...
insert into psm.user_election(organization_id,user_id,pollingstation_id,election_id) 
select orgid,userid,pollingstationid,ue.election_id FROM psm.polling_station_election ue
where ue.organization_id=orgid and ue.polling_station_id=pollingstationid;
...
-- Dump completed on 2016-04-26 14:42:39
CREATE DATABASE  IF NOT EXISTS `security` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `security`;
-- MySQL dump 10.13  Distrib 5.7.9, for Win64 (x86_64)
--
-- Host: ec2-52-16-78-172.eu-west-1.compute.amazonaws.com    Database: security
-- ------------------------------------------------------
-- Server version	5.5.47-0ubuntu0.14.04.1
...
) ENGINE=InnoDB AUTO_INCREMENT=27970 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2016-04-26 14:42:53
CREATE DATABASE  IF NOT EXISTS `subscription` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `subscription`;
-- MySQL dump 10.13  Distrib 5.7.9, for Win64 (x86_64)
--
-- Host: ec2-52-16-78-172.eu-west-1.compute.amazonaws.com    Database: subscription
-- ------------------------------------------------------
-- Server version	5.5.47-0ubuntu0.14.04.1
...
-- Dump completed on 2016-04-26 14:43:03
