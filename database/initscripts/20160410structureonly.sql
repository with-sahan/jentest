...
-- Dump completed on 2016-04-10 22:12:37
-- MySQL dump 10.13  Distrib 5.7.9, for Win64 (x86_64)
--
...
BEGIN
    ...
    if (security.fn_validate_token(token)=1) then
		...
		where lc.name like 'psi_checklist%' and org.code = orgcode order by lc.list_order,l.list_order;
...
-- Dump completed on 2016-04-10 22:13:23
-- MySQL dump 10.13  Distrib 5.7.9, for Win64 (x86_64)
--
...
-- Dump completed on 2016-04-10 22:13:35
