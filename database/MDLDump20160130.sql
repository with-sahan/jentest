...
INSERT INTO `election` VALUES (1,2,'Police Comminisoner Election','2016-01-20 07:00:00','2016-01-29 12:00:00',0,NULL),(2,2,'Mayor Election','2016-01-29 07:00:00','2016-01-29 20:00:00',0,NULL),(3,2,'Presidential Election','2016-01-21 07:00:00','2016-01-29 23:00:00',0,NULL),(4,3,'Mayor Election','2016-01-29 07:00:00','2016-01-30 18:00:00',0,NULL),(5,4,'Mayor Election','2016-01-29 07:00:00','2016-01-29 18:00:00',0,NULL);
...
INSERT INTO `election_close_stats` VALUES (9,2,1,450,10,552,220,22,22,'2016-01-30 03:35:24',1),(10,2,2,11,1,1,1,1,11,'2016-01-30 03:35:24',2),(11,2,2,800,300,500,200,100,100,'2016-01-30 03:35:24',1),(12,2,1,10000,1000,1000,100,1000,100,'2016-01-30 03:35:24',2),(13,2,2,11,1,1,1,1,1,'2016-01-30 03:35:24',5),(14,4,5,100,20,10,20,10,20,'2016-01-30 03:35:24',8),(15,2,1,5454555,555555,55555,54,454,4545,'2016-01-30 03:35:24',4),(16,2,1,100,90,100,100,100,100,'2016-01-30 03:35:24',5),(17,3,4,1,1,0,1,1,1,'2016-01-30 03:35:24',6),(18,3,4,1,1,1,1,1,1,'2016-01-30 03:35:24',7);
...
INSERT INTO `issue_assignment` VALUES (1,2,6,5);
...
INSERT INTO `polling_station_election` VALUES (1,2,1,1,1,1,'13:30:54',NULL,'2016-01-28 05:56:05'),(2,2,2,2,1,0,'05:52:40',NULL,'2016-01-21 10:06:03'),(3,2,1,2,1,0,'13:30:54',NULL,'2016-01-21 14:32:09'),(4,2,2,1,1,0,'05:52:40',NULL,'2016-01-21 10:06:06'),(5,2,3,3,0,0,'11:01:48',NULL,NULL),(6,2,4,1,0,0,'00:00:00',NULL,NULL),(7,2,5,2,0,0,'13:28:01',NULL,'2016-01-21 14:02:09'),(8,2,5,1,0,0,'13:28:01',NULL,NULL),(9,3,6,4,1,1,'09:51:27',NULL,'2016-01-27 10:36:04'),(10,3,7,4,1,1,'06:05:23',NULL,'2016-01-27 10:39:39'),(11,4,8,5,0,0,'00:00:00',NULL,NULL),(12,4,9,5,0,0,'00:00:00',NULL,NULL),(13,2,3,1,0,0,'11:01:48',NULL,NULL),(14,2,5,3,0,0,'13:28:01',NULL,NULL);
...
INSERT INTO `tracking` VALUES (2,2,1,1,'79.861243','6.9270786',2,'address','2016-01-21 10:30:55','2016-01-28 05:59:32',NULL),(3,2,2,2,'79.861243','6.9270786',2,'address','2016-01-21 10:30:55','2016-01-28 05:59:32',NULL),(5,4,8,5,'1','1',2,'address','2016-01-22 05:56:45','2016-01-22 06:01:25',NULL),(6,4,9,5,'1','1',2,'address','2016-01-22 05:56:45','2016-01-22 06:01:25',NULL),(20,3,6,4,'79.861243','6.9270786',1,'address','2016-01-25 12:49:43',NULL,NULL),(21,3,7,4,'79.861243','6.9270786',1,'address','2016-01-25 12:49:43',NULL,NULL);
...
BEGIN
    ...
    if (security.fn_validate_token(token)=1 and security.fn_validate_permission(token,spcode,'Admin')=1) then
        ...
        ecs.tot_tend_spoiled,ecs.tot_tend_unused,el.election_name as electionname,ps.name as pollingstation,'ok' as response from 
        ...
        null as tot_tend_unused,null as electionname,null as pollingstation,'unauthorized' as response; 
    end if;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
BEGIN
    ...
    if (security.fn_validate_token(token)=1 and security.fn_validate_permission(token,spcode,'Admin')=1) then
        ...
        sum(ecs.tot_tend_spoiled) as sum_tot_tend_spoiled,sum(ecs.tot_tend_unused) as sum_tot_tend_unused,'ok' as response from 
        ...
        null as sum_tot_tend_unused,'unauthorized' as response; 
    end if;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
BEGIN
    ...
    if (security.fn_validate_token(token)=1) then
			SELECT (HOUR(election_date_start)) as starttime, (TIMESTAMPDIFF(HOUR,election_date_start,election_date_end)) 
			as diff from psm.election WHERE UNIX_TIMESTAMP(DATE(election_date_start)) = UNIX_TIMESTAMP(CURDATE());
	else
...
-- Dump completed on 2016-01-30  9:39:14
-- MySQL dump 10.13  Distrib 5.7.9, for Win64 (x86_64)
--
...
-- Dump completed on 2016-01-30  9:39:41
-- MySQL dump 10.13  Distrib 5.7.9, for Win64 (x86_64)
--
...
-- Dump completed on 2016-01-30  9:40:02
