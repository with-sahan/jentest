...
CREATE TABLE `chat` (
  ...
  PRIMARY KEY (`chatid`)
) ENGINE=InnoDB AUTO_INCREMENT=480 DEFAULT CHARSET=utf8 COMMENT='Using for viewing chat messages in issues';
...
) ENGINE=InnoDB AUTO_INCREMENT=65 DEFAULT CHARSET=utf8 COMMENT='Counting centers master table';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `election_close_stats` VALUES (47,6,9,349,0,1351,0,0,10,'2016-02-19 23:26:14',171),(48,6,9,254,0,1246,0,0,10,'2016-02-19 23:26:35',172),(49,12,56,0,0,1,0,0,1,'2016-04-01 08:02:04',228),(50,16,61,0,0,1,0,0,1,'2016-04-01 08:13:12',233),(51,16,62,2000,200,117799,250,30,99750,'2016-04-01 09:50:43',231);
...
-- Dump completed on 2016-04-01 16:55:08
