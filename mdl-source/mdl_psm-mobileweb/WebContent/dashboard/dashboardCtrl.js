...
angular.module('newApp').controller('mdl.mobileweb.controller.dashboard',
		[ '$rootScope', '$scope', 'mdl.mobileweb.service.dashboard','$location','$filter','$interval','toaster', 'mdl.mobileweb.service.chatFetchService', 'mdl.mobileweb.service.issueAssignFetchService',
		  function($rootScope, $scope, dashboardService, $location,$filter,$interval,toaster, chatFetchService, issueAssignFetchService) {
			var vm = this;
			vm.timerPromise;
			vm.elections = [];
			vm.allElectionStats = [];
...
//					}
			...
			vm.timerPromis=$interval(vm.timermethods, 90000);
