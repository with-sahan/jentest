...
angular.module('newApp').factory('dashboardService', function () {
    ...
    dashboard.triggerIssueCount = function(chatCount, issueID, pollingstationID, status) {
        /* Chats, demo purpose */
    	if(typeof chatCount != "undefined"){
    		sessionStorage.issue_id = issueID;
    		sessionStorage.pollingstation_id = pollingstationID;
    		sessionStorage.issue_status = status;
            //notifContent = '<div class="alert alert-dark media fade in bd-0" id="message-alert"><div class="media-left"><a href="#reportissue/unresolved_issue"><i class="fa fa-bell faa-ring animated"></i></a></div><div class="media-body width-100p"><h4 class="alert-title f-14">'+ chatCount +' chats added!</h4><p><a href="#/reportissue/unresolved_issue" class="f-12" style="margin-right:10px">Check them here.</a></p></div></div>';
    		...
    		notifContent = '<div class="alert alert-dark media fade in bd-0" id="message-alert"><div class="media-left"><a href="#reportissue/all_issues"><i class="fa fa-bell faa-ring animated"></i></a></div><div class="media-body width-100p"><h4 class="alert-title f-14"> A new chat has added!</h4><p><a href="#/reportissue/all_issues" class="f-12" style="margin-right:10px">Check them here.</a></p></div></div>';
    ...
    dashboard.triggerAssignCount = function(assignCount, issueID, pollingstationID) {
    	...
    	if(typeof assignCount != "undefined"){
    		sessionStorage.issue_id_assignment = issueID;
    		sessionStorage.pollingstation_id_assignment = pollingstationID;
    		//alert(sessionStorage.issue_id_assignment);
    		//alert(pollingstationID);
            notifContent = '<div class="alert alert-dark media fade in bd-0" id="message-alert"><div class="media-left"><a href="#reportissue/all_issues"><i class="fa fa-bell faa-ring animated"></i></a></div><div class="media-body width-100p"><h4 class="alert-title f-14"> A new issue is assigned to you!</h4><p><a href="#/reportissue/all_issues" class="f-12" style="margin-right:10px">Check them here.</a></p></div></div>';
    		if(typeof dashboard.notifyflag != 'undefined'){
            	dashboard.notifyflag.close();
            }
            dashboard.notifyflag = generateNotifDashboard(notifContent);    		
